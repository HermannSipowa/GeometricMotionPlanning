...
for ll = 1
    ...
    % q_t0 = load('q_t0.mat'); % matfile('indexYCentralized.mat');
    % qr_chasser00 = q_t0.qr_chasser00;
    % q_tf = load('q_tf.mat'); % matfile('indexYCentralized.mat');
    % qr_chasserf0 = q_tf.qr_chasserf0;
