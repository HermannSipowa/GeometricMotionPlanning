function [p, dp, xfull, xdrift, bufull, budrift, sol, t, x, xnew, cost, X_ode45] = unicycle_drift_AGHF(tmax, xpoints, intgrids, tpoints, k, X, Xf, T, N, M)
...
% opts = odeset('RelTol',2.22045e-14,'AbsTol',2.22045e-30);
tic;
disp('solving PDE...');
% Solve AGHF
