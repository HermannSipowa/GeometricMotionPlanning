...
CASADI_SYMBOL_EXPORT casadi_int fdrift_n_in(void) { return 2;}
...
void mex_fdrift(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  casadi_real* res[1] = {0};
  if (argc>2) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"fdrift\" failed. Too many input arguments (%d, max 2)", argc);
  ...
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+1, casadi_s1, w+25);
  --resc;
  res[0] = w+13;
  i = fdrift(arg, res, iw, w+25, 0);
