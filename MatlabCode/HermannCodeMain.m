...
%---------------------------- AGHF parameters ----------------------------
% Boundary conditions
jj = 2; idx = 1+mm*(jj-1):mm*jj; X0 = X_rel(1,idx)'; 
jj = 1; idx = 1+mm*(jj-1):mm*jj; Xf = X_rel_1(1,idx)';
...
plot3(p_initial(1,:),p_initial(2,:),p_initial(3,:),'g','LineWidth',2);
...
%%
figure
plot3(p(4,:),p(5,:),p(6,:),'k','LineWidth',2);
hold on
plot3(p_initial(4,:),p_initial(5,:),p_initial(6,:),'g','LineWidth',2);
grid on
%%
