...
[p, dp, xfull, xdrift, bufull, budrift, sol, s, t, tint, cost,X_ode45] = unicycle_drift_AGHF(smax, tgrids, intgrids, sgrids, k, X0, Xf, T, N, M);
...
plot(interp1(tint,X_ode45(1,:),t),interp1(tint,X_ode45(2,:),t),'--r','LineWidth',2);

legend('AGHF solution', 'integrated path',  'integrated ODE45', 'AutoUpdate','off')
